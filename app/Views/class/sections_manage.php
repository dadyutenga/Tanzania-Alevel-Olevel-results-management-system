        ...
        <div class="main-content">
            <div class="container">
                ...
                <div class="form-container">
                    <form method="POST" action="<?= isset($section) ? base_url('classes/sections/update/' . $section['id']) : base_url('classes/sections/store') ?>">
                        <?= csrf_field() ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="is_active" name="is_active">
                                <option value="yes" <?= old('is_active', $section['is_active'] ?? 'yes') === 'yes' ? 'selected' : '' ?>>Active</option>
                                <option value="no" <?= old('is_active', $section['is_active'] ?? 'yes') === 'no' ? 'selected' : '' ?>>Inactive</option>
                            </select>
                        </div>

                        <div class="form-actions">
                            <button type="submit" class="btn">
                                <i class="fas fa-save"></i> <?= isset($section) ? 'Update Section' : 'Save Section' ?>
                            </button>
                            <a href="<?= base_url('classes/sections') ?>" class="btn btn-secondary">
